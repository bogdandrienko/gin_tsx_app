...
class SettingsModel(models.Model):
    ...
    LIST_DB_VIEW_CHOICES = [
        ("logging_action", 'Логирование действий в базу ("logging_action=True/False")',),
        ("print_action", 'Вывод в консоль действий ("print_action=True/False")',),

        ("logging_error", 'Логирование ошибок в базу ("logging_error=True/False")',),
        ("print_error", 'Вывод в консоль ошибок ("print_error=True/False")',),

        ("logging_response", 'Логирование ответов в базу ("logging_response=True/False")',),
        ("print_response", 'Вывод в консоль ответов ("print_response=True/False")',),
    ...
    value = models.CharField(
        ...
        help_text='<small class="text-muted">CharField [0, 500]</small><hr><br>',
    ...
    @staticmethod
    def get_value(type_: str) -> str:
        try:
            return SettingsModel.objects.get(type=type_).value
        except Exception as error:
            SettingsModel.objects.get_or_create(type=type_)
            return ""
