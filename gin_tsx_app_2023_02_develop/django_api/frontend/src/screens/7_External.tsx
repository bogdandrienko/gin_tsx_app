              ...
              <div className="container">
                <div className="px-4 py-1 my-5 text-center">
                  ...
                  <div className="col-lg-6 mx-auto">
                    <p className="lead mb-4">
                      Интеграция и агрегация данных из внешних систем
                    </p>
                  </div>
                </div>
                <div className="container marketing">
                  <div className="row">
                    {[
                      {
                        title: "Позиционирование персонала",
                        description:
                          "выборка, оповещения, графики, аналитика с внешней открытой службы",
                        image: "",
                        link: "",
                      },
                      {
                      ...
                      },
                      {
                        ...
                        description:
                          "выборка данных с оборудования оборудованного сетевыми контроллерами",
                        image: "",
                        link: "",
                      },
                    ].map(
